...
<div class="page-title">
    <h2><span class="fa fa-arrow-circle-o-left"></span>Booking Data</h2>
</div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="btn-group pull-right">
                        <button class="btn btn-success" onclick="window.location='Booking/add_booking'"><i class="fa fa-bars"></i>New Booking</button>
                    </div>
                    <div class="btn-group pull-right">
